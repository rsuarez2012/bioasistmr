...
$.fn.pagination.defaults={total:1,pageSize:21,pageNumber:1,pageList:[21,42, 63],loading:false,buttons:null,showPageList:true,showRefresh:true,onSelectPage:function(_8c,_8d){
},onBeforeRefresh:function(_8e,_8f){
},onRefresh:function(_90,_91){
},onChangePageSize:function(_92){
},beforePageText:"Página",afterPageText:"de {pages}",displayMsg:"Mostrando {from} hasta {to}, Total: {total} registros"};
})(jQuery);
(function($){
function _93(_94){
var _95=$(_94);
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"Campo Requerido!",invalidMessage:null,rules:{email:{validator:function(_39c){
...
},message:"Por favor, ingrese una dirección valida!."},url:{validator:function(_39d){
...
},message:"Por favor, ingrese una URL valida!"},length:{validator:function(_39e,_39f){
var len=$.trim(_39e).length;
return len>=_39f[0]&&len<=_39f[1];
},message:"Por favor, ingrese un valor entre {0} y {1}."},remote:{validator:function(_3a0,_3a1){
var data={};
data[_3a1[1]]=_3a0;
var _3a2=$.ajax({url:_3a1[0],dataType:"json",data:data,async:false,cache:false,type:"post"}).responseText;
return _3a2=="true";
},message:"Por favor, corregir este campo!!"}}};
})(jQuery);
(function($){
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:false,autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,loadMsg:"Procesando, por favor espere...",rownumbers:false,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_5e3,_5e4){
