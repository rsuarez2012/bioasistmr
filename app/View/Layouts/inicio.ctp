...
<body>
		<div id="encabezado">
			...
			<div id="sesion-cerrar">Conectado: <span><?php echo $usu['usuario']; ?></span>  -  Salir<?php echo $this->Html->image('salir.png', array('alt' => 'Cerrar Sesión', 'width' => '20', 'align' => 'absmiddle', 'border' => 0, 'url' => array('controller' => 'usuarios', 'action' => 'logout')));?></div>
		</div>		
		<div id="contenedor">			
			<div id="cuerpo-full">									
