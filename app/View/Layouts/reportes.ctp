...
<head>
	...
	<?php		
		...
		echo $this->Html->script(array('jquery-1.8.0','jquery.easyui.min', 'jquery-ui-1.8.custom.min', 'datagrid-detailview', 'funciones'));
...
<body>
		<div id="encabezado">
			...
			<div id="sesion-cerrar"><? if(isset($usu)){ ?>Conectado: <span><?php echo $usu['usuario']; ?></span><a href="<?php echo $sitioUrl.'usuarios/inicio';?>" title="Inicio"><?php echo $this->Html->image('home.png', array('alt' => 'Inicio', 'width' => '20', 'align' => 'absmiddle', 'border' => 0));?></a><?php echo $this->Html->image('salir.png', array('alt' => 'Cerrar Sesión', 'width' => '20', 'align' => 'absmiddle', 'title' => 'Salir', 'border' => 0, 'url' => array('controller' => 'usuarios', 'action' => 'logout'))); }?></div>
		</div>		
		<div id="contenedor">				
			<div id="cuerpo">									
