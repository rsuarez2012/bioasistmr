...
<table border="1">
    <tr bgcolor="#D3D7FF">
        <th align="center" width="15px">Nº</th>
        <th align="center" width="130px">Materias</th>
        <th align="center" width="225">Profesor</th>
        <th align="center" width="80px">Dia</th>
...
$html = $html.'
    <tr>
        ...
        <td align="center">'.$noticia['dias']['dia_nombre'].'</td>
        <td align="center">'.$noticia['secciones']['seccion_nombre'].'</td>        
        <td align="center">'.bloqueHora($bloques,$noticia['horarios']['inicio']).'</td>
        <td align="center">'.bloqueHora($bloques,$noticia['horarios']['fin']).'</td>
        <td align="center">'.$noticia['aulas']['aula_nombre'].'</td>
    </tr>
';
$i++;
}
