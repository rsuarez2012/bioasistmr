...
EOD;
$i=1;
foreach($personal as $noticia){
$html = $html.'
    <tr>
        <td align="center">'.$i.'</td>
        <td align="center">'.$noticia['Personal']['cedula'].'</td>
        <td align="center">'.$noticia['Personal']['nombres'].'</td>
        <td align="center">'.$noticia['Personal']['apellidos'].'</td>
        <td align="center">'.$noticia['Personal']['telefono'].'</td>
        <td align="center">'.$noticia['Personal']['email'].'</td>        
    </tr>
';
$i++;
}
