...
<table id="dg" title="Tipo de Personal" class="easyui-datagrid" style="height:610px" url="verTipoPersonal"  toolbar="#toolbar"  pagination="true" rownumbers="true" fitColumns="true" singleSelect="true">  
    <thead>  
        <tr>  
        	<th field="nombre" width="20" sortable="true" align="left">Nombre</th>            
        </tr>          
    </thead>  
</table>  
<div id="toolbar"> 
...
<div id="dlg" class="easyui-dialog" style="width:280px;height:150px;padding:10px 20px;" closed="true">		
		<form id="fm" method="post" novalidate>
		<?php //echo $this->Form->create('Usuario', array('div' => false, 'method' => 'post', 'id' => 'fm', 'action' => 'agregar', 'novalidate')); ?>
		<table>	
			<tr>
				<td><label>Nombre:</label></td>
				<td><?php echo $this->Form->textarea('nombre', array('div' => false, 'class' => 'easyui-validatebox', 'label' => false, 'name' => 'nombre'))?></td>
			</tr>
		</table>					
		</form>	
		<div id="dlg-buttons">
