...
<tr bgcolor="#D3D7FF">
    ...
    <th align="center" width="200px">Email</th></tr>
...
$html = $html.'
    <tr>
        ...
        <td align="center">'.$noticia['Usuario']['cedula'].'</td>
        <td align="center">'.$noticia['Usuario']['nombres'].'</td>
        <td align="center">'.$noticia['Usuario']['apellidos'].'</td>
        <td align="center">'.$noticia['Usuario']['telefono'].'</td>
        <td align="center">'.$noticia['Usuario']['email'].'</td>
    </tr>
';
$i++;
}
