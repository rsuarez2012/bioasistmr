...
class AppController extends Controller {
  /*var $components = array('Auth');
 	...
 	function inicializarAuth(){
		 ...
		 $this->Auth->fields = array('username' => 'usuario', 'password' => 'clave');
		 ...
		 $this->Auth->authError = 'Para acceder, debe iniciar con su usuario!!';
 	...
 	*/
 	/*function beforeFilter(){
 		...
 		{
 			$this->Session->setFlash('Acceso Restringido!!');
